...
//
//        @Override
//        public void onBindViewHolder(@NonNull LocalitiesVH holder, final int position) {
...
//        @NonNull
//        @Override
//        public LocalitiesVH onCreateViewHolder(@NonNull ViewGroup parent, int i) {
//
//            View itemView = LayoutInflater.
//                    from(parent.getContext()).
//                    inflate(R.layout.filter_location_item, parent, false);
//
//            return new LocalitiesVH(itemView);
//        }
//
